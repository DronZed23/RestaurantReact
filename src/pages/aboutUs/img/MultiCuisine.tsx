...
export const MultiCuisine = ({ className } : Props) => (
    <svg className={className} width="42" height="48" viewBox="0 0 42 48" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M17 22C20.3137 22 23 19.3137 23 16C23 12.6863 20.3137 10 17 10C13.6863 10 11 12.6863 11 16C11 19.3137 13.6863 22 17 22Z" stroke="#AD343E" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
);